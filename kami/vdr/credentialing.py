...
"""
KERI
kami.vdr.credentialing module

VC issuer support
"""
from kami.help import decking

from kami.vdr import viring
from .. import kering
from .. import logs
from ..app.habbing import GroupHab
from ..core import parsing, coring, serdering
...
class RegeryDoer:  # used to be (doing.Doer):
    pass
    # """
    # Doer for a Regery
    # """
...
class Registrar:  # used to be a (doing.DoDoer):
    pass
    #
...
class Credentialer:  # used to be a (doing.DoDoer):
    pass
    #
...
def sendCredential(hby, hab, reger, postman, creder, recp):
    ...
    if isinstance(hab, GroupHab):
        sender = hab.mhab.pre  # noqa: F841
    else:
        sender = hab.pre  # noqa: F841

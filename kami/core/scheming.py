...
from . import coring
from .coring import Saids, Saider, MtrDex
from .. import kering, logs
from ..kering import Serials, ValidationError, DeserializeError
        ...
        if self.id_ in sed:
            ...
            if not saider.verify(sed, prefixed=True, kind=kind, label=self.id_):
                raise ValidationError(
                    "invalid self-addressing identifier {} instead of {} in schema = {}"

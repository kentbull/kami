...
from .coring import DigDex, PreDex, Saids, Digestage
from .coring import (Matter, Verfer, Diger, Number, Tholder, Ilker, Traitor, Verser, )
from .. import logs
from ..core import coring
from ..core.counting import GenDex, AllTags, Counter
from ..help import helping
from ..kering import Protocols, Serials, versify, deversify, Ilks, InvalidValueError, VersionError
from ..kering import smell
from ..kering import (ValidationError, MissingFieldError, ExtraFieldError,
                      AlternateFieldError,
                      ProtocolError, DeserializeError, FieldError, SerializeError)
from ..kering import (Vrsn_1_0, Vrsn_2_0, VER1FULLSPAN, VER2FULLSPAN)
...
class Serder:
    ...
    def __init__(self, *, raw=b'', sad=None, strip=False, smellage=None,
        ...
        if raw:  # deserialize raw using property setter
            ...
            raise InvalidValueError("Improper initialization need raw or sad or makify.")
    ...
    def _dumps(self, sad):
        ...
        if self.proto == Protocols.keri:
            for l, v in sad.items():  # assumes valid field order & presence  # noqa: E741
                    ...
                    case "a":  # list of seals or field map of attributes
                        ...
                        for e in v:  # list of seal dicts
                            pass
                                ...
                                #SealSourceCouples: str = '-Q'  # Seal Source Couple(s), snu+dig of source sealing or sealed event.     # noqa: E501
                                #SealSourceTriples: str = '-R'  # Seal Source Triple(s), pre+snu+dig of source sealing or sealed event. # noqa: E501
                                #DigestSealSingles: str = '-V'  # Digest Seal Single(s), dig of sealed data.                            # noqa: E501
                                #MerkleRootSealSingles: str = '-W'  # Merkle Tree Root Digest Seal Single(s), dig of sealed data.       # noqa: E501
                                #BackerRegistrarSealCouples: str = '-X'  # Backer Registrar Seal Couple(s), brid+dig of sealed data.    # noqa: E501
            ...
            # assumes valid field order & presence
            for l, val in sad.items():  # noqa: F841, E741
                if not fixed:
                    pass  # prepend label
    ...
    def compare(self, said=None):
        ...
        if said is not None:
            ...
            raise ValidationError(f"Uncomparable saids arg={said} and self.saidb={self.saidb}.")

...
class WireLog():
    ...
    buffers for logs 'over the wire' network tx and rx packets as bytes
    ...
    def __init__(self, rxed=True, txed=True, samed=False, filed=False,
        ...
        Parameters:
            ...
            prefix is str to include in path and logs template
...
class WireLogDoer:  # used to be a (doing.Doer)
    pass
    # """
    # Basic WireLog Doer
    #

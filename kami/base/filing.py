# -*- encoding: utf-8 -*-
"""
kami.base.filing module

TODO convert to aiofiles rather than os, stat, shutil, and tempfile
"""
import os
import shutil
import stat
...
from kami.help.helping import ocfn
from .. import logs
    ...
    def remake(self, *, name="", base="", temp=None, headDirPath=None, perm=None,
        ...
        if temp:
            ...
            if not os.path.exists(path):  # no path so attempt to create
                ...
                except OSError:  # use alt instead should always succeed

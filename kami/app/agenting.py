...
class Receiptor:  # used to be a (doing.DoDoer)
    pass
...
class WitnessReceiptor:  # used to be a (doing.DoDoer)
    pass
    # """
    ...
    #                             # Newly added witness, must send full KEL to catch up
    ...
    #                     _ = yield self.tock
    #
    #             # If we started with all our recipts, exit
    #             # unless told to force resubmit of all receipts
...
class WitnessInquisitor:  # used to be a (doing.DoDoer)
    pass
    # """
    # Sends messages to all current witnesses of given identifier (from hab) and waits
    # for receipts from each of those witnesses and propagates those receipts to each
...
class WitnessPublisher:  # used to be a (doing.DoDoer)
    pass
    # """
...
class TCPMessenger:  # used to be a (doing.DoDoer)
    pass
...
class TCPStreamMessenger:  # used to be a (doing.DoDoer)
    pass
    # """ Send events to witnesses for receipting using TCP direct connection
    #
    # """
...
class HTTPMessenger:  # used to be a (doing.DoDoer)
    pass
    # """
...
class HTTPStreamMessenger:  # used to be a (doing.DoDoer)
    pass
    # """
    # Interacts with Recipients on HTTP and SSE for sending events and receiving receipts
    #
...
def httpClient(hab, wit) -> aiohttp.ClientSession:
    ...
    url = urls[kering.Schemes.http] if kering.Schemes.http in urls else urls[kering.Schemes.https]
    up = urlparse(url)
    # TODO rewrite with async/await and aiohttp for the client
    print(f"URL parsed is: {up}")  # TODO remove - is for eliminating linter warning
    # client = http.clienting.Client(scheme=up.scheme, hostname=up.hostname, port=up.port)
    # clientDoer = http.clienting.ClientDoer(client=client)

    # TODO return client using urls from above

# -*- encoding: utf-8 -*-
"""
kami.kli.common.oobiing module
...
from kami.help import decking, Deck
from . import httping
...
class Oobiery:
    ...
    def __init__(self, hby: Habery, clienter: Clienter = None, cues: Deck = None):
        ...
        # TODO rewrite to use aiohttp and asyncio
...
class Authenticator:
    ...
    def __init__(self, hby, clienter=None):
        ...
        # What will run the Authenticator? Is it middleware?

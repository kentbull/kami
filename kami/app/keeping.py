...
from kami.db import dbing, subing, koming
...
class Manager:
        ...
        while secrecies:
            ...
            if ridx == max(iridx - 1, 0):  # setup ps.old at this ridx
                if iridx == 0:
                    ...
                    ost = coring.Tholder(sith=osith).sith  # noqa: F841
    ...
    def replay(self, pre, dcode=coring.MtrDex.Blake3_256, advance=True, erase=True):
        ...
        """
        if (pp := self.ks.prms.get(pre)) is None:  # noqa: F841
...
class ManagerDoer:  # used to be a (doing.Doer)
    pass
    # """
